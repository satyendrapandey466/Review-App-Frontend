...
export default function SingleMovie() {
  ...
  return (
    <div className="dark:bg-primary bg-white min-h-screen pb-10 pl-3 pr-2">
      <Container className="xl:px-0 px-2 ">
        <video poster={poster} controls src={trailer} className="min-w-full w-screen  max-h-screen"></video>
