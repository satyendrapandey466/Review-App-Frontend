...
//This component renderes modal for view all casts
export default function CastModal({
  casts = [],//List of all cast profiles
  visible,//set visibility of modal
  onClose,//sets visiblility to false
  onRemoveClick,//gets an id which cast profile is going to be removed
}) {
  return (
