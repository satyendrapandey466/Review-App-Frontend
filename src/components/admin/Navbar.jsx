...
//Component rendering the navbar for the admin UI
export default function Navbar() {
  const { handleLogout } = useAuth(); //getting the logout  functionality from Auth context
  return (
    <nav className="w-48 min-h-screen bg-secondary border-r border-gray-300">
      ...
      <div className="flex flex-col justify-between pl-5 h-screen sticky top-0">
        {/* Div to handle the the color the div */}
        <ul>
          {/*Handles the list to be shown in the navbar */}
          <li className="mb-8">
            <Link to="/">
        ...
        {/* Logout section shown to the bottom* */}
